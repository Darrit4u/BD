...
class AddClassroomDialog(QDialog):
    ...
    def get_values(self):
        return self.name_edit.text(), self.building_edit.currentText(), self.type_edit.currentText(), int(self.capacity_edit.text())
...
class App(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon('C:/Users/kirill/Desktop/КП БД/icon.ico'))
    ...
    def load_teachers(self):
        ...
        self.teachers_table.setHorizontalHeaderLabels(["Id", "Фамилия", "Имя", "Отчество", "MAX кол-во часов"])
    ...
    def add_teacher(self):
        ...
        result = dialog.exec_()
        if result == QDialog.Accepted:
            name, surname, otchestvo, max_hours = dialog.get_values()
            cursor = self.connection.cursor()
    ...
    def add_classroom(self):
        ...
        result = dialog.exec_()
        if result == QDialog.Accepted:
            name, building, room_type, capacity = dialog.get_values()
            print(type(name))
            cursor = self.connection.cursor()
    ...
    def update_schedule(self):
        ...
        self.schedule_table.setHorizontalHeaderLabels(["Дата", "Время", "Аудитория", "Преподаватель", "Группа", "Предмет", "Тип"])
        ...
        if group_value == "all" and (teacher_id == "all" or teacher_id == ""):
            cursor.execute(f"""
                ...
                groups.group_name, subjects.subject_name, schedule.type
                FROM schedule
